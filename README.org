...
* Notes:
- The main executable opens ifstreams to read the poorly indented files "bad-code.cpp" and "bad-code2.cpp" and
rewrites them into "fixed-bad-code.cpp" and "fixed-bad-code2.cpp" using ofstreams.
